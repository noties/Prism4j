...
@PrismBundle(include = {"markup", "javascript"}, name = ".GrammarLocatorMarkupJavascript")
public class Test_markup_javascript {
    ...
    @Before
    public void before() {
        prism4j = new Prism4j(new GrammarLocatorMarkupJavascript());
    }

    private String file;

    public Test_markup_javascript(@NonNull String file) {
        this.file = file;
    }
